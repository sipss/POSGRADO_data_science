...
```{r}
pca_model_ncomp <- 50
intensity_scores_trn <- ChemometricsWithR::project(pca_model, npc = pca_model_ncomp, intensity_trn_preproc)
...
```{r}
pca_model_loadings <- pls::loadings(pca_model, pca_model_ncomp)
